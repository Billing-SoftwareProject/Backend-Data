...
CREATE TABLE `product` (
  ...
  CONSTRAINT `product_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `vendor` (`id`)
...
INSERT INTO `product` VALUES (21,'sweets',1,25,100),(22,'viraj',1,25,100),(24,'vishal',1,25,100),(26,'Pede',1,25,100);
...
-- Dump completed on 2023-10-11 18:34:55
